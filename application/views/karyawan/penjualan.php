          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('index.php/Karyawan/v_penjualan'); ?>">
                <span class="menu-title" style="color: #87CEEB;font-weight: bold;">Penjualan</span>
                <i class="mdi mdi-coin menu-icon" style="color: #87CEEB;font-size: 30px;"></i>
              </a>
            </li>
          </ul>
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body"style="padding-left: 20px;">
                      <form method="post" action="<?php echo base_url('index.php/Tambah/t_penjualan');?>">
                    
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;width: 120px;height: 38px;"><b>Nama Obat</b></span>
                    </div>
                   <select required id="data_nama" name="nama" class="selectpicker form-control" style="text-transform:capitalize;color: black;" data-live-search="true">
                 ...
                 <!--  <select id="data_nama" class="selectpicker form-control"  name="nama" data-live-search="true" required>
                  ...
                  <div class="input-group">
                    ...
                    <input id="data_exp" name="tgl_exp" type="text" class="form-control" style="text-transform:capitalize;" placeholder="Tangggal kadaluarsa" readonly>
                  </div>
                  <br>
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;width: 120px;"><b>Keterangan</b></span>
                    </div>
                    <input id="data_keterangan" name="keterangan" type="text" class="form-control" style="text-transform:capitalize;" placeholder="Keterangan" readonly>
                  </div>
                  <br>
                  ...
                  <div class="input-group">
                    ...
                    <input id="data_harga" name="harga_jual" type="number" class="form-control" style="text-transform:capitalize;" readonly min="0" step="1" placeholder="Harga Beli" />
  ...
  function load(){
    ...
    $.ajax({
      ...
      success:function(data){
        console.log(data);
        document.getElementById("data_harga").value = data[0].harga_jual;
        document.getElementById("data_keterangan").value = data[0].keterangan;
        document.getElementById("data_kategori").value = data[0].kategori_obat;
        document.getElementById("data_stok").value = data[0].stok;
        document.getElementById("data_exp").value = data[0].tgl_exp;
