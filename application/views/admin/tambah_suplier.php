              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> 
                    ...
                    <a class="nav-link" href="<?php echo base_url('index.php/Admin/v_tambah_suplier'); ?>" style="color: #87CEEB;">Suplier</a>
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body"style="padding-left: 20px;">
                      <form method="post" action="<?php echo base_url('index.php/Tambah/t_suplier');?>">
                    
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;width: 100px;"><b>Nama Suplier</b></span>
                    </div>
                    <input name="suplier" type="text" class="form-control" style="text-transform:capitalize;" /required min="0" step="1" placeholder="Input Nama Suplier" />
                  </div><br>
                    
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;width: 100px;"><b>Alamat</b></span>
                    </div>
                    <input name="alamat" type="text" placeholder="Input alamat suplier" class="form-control" style="text-transform:capitalize;" >
                  </div>
                  <br>

                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;width: 100px;"><b>Kontak</b></span>
                    </div>
                    <input name="cp" type="text" class="form-control" style="text-transform:capitalize;" /required min="0" step="1" placeholder="Input kontak yang dapat di hubungi" />
                    <div class="input-group-prepend">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                  <div class="card-body">
                    ...
                    <input class="form-control" type="text" id="myInput" placeholder="Cari Supplier">
                      ...
                      <table class="table" id="myTable">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo $row->cp_sup; ?></td>
                            <td><?php echo $row->alamat_sup; ?></td>
                            
                            <td><center><a class="btn btn-info" style="background: white;border: 2px solid #87CEEB;color: black;" onclick="return checkDelete()" href="<?php echo base_url('index.php/Hapussuplier/?suplier='.$row->nama_sup); ?>" >hapus</a></center></td>
                          </tr>
                          <?php endforeach; ?>
                        </tbody>
                      </table>
...
function checkDelete(){
    return confirm('Yakin ingin hapus?, data suplier akan terhapus!');
}
</script>
