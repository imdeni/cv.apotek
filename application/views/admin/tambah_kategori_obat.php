              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> 
                    ...
                    <a class="nav-link" href="<?php echo base_url('index.php/Admin/v_tambah_kategori_obat'); ?>" style="color: #87CEEB;">Kategori Obat</a>
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body"style="padding-left: 20px;">
                      <form method="post" action="<?php echo base_url('index.php/Tambah/t_kategori_obat');?>">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="kategori" placeholder="Silahkan Input Nama Kategori" class="form-control" style="text-transform:capitalize;" /required>
                    <div class="input-group-prepend">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                  <div class="card-body">
                    ...
                    <input class="form-control" type="text" id="myInput" placeholder="Cari Kategori Obat">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <?php $no++; ?>
                                  ...
                                  <td><center><a class="btn btn-info" style="background: white;border: 2px solid #87CEEB;color: black;" onclick="return checkDelete()" href="<?php echo base_url('index.php/Hapus2/?kategori='.$row->nama_kategori); ?>" >hapus</a></center></td>
...
function checkDelete(){
    return confirm('Yakin ingin hapus?, nama obat pada menu nama obat dan menu harga obat akan terhapus!');
}
</script>
