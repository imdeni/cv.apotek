          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url('index.php/Admin/data_stok'); ?>">
                <span class="menu-title" style="color: #87CEEB;font-weight: bold;">Monitoring Stok Obat</span>
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body"style="padding-left: 20px;">
                      <form method="post" action="<?php echo base_url('index.php/Admin/t_kategori_obat');?>">
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;width: 100px;"><b>Nama Obat</b></span>
                    </div>
                    <select class="form-control" style="text-transform:capitalize;max-width: 400px;">
                      <option>Silahkan klik untuk memilih nama obat</option>
                      <option>data 1</option>
                      <option>data 2</option>
                    </select>
                  
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;"><b>Kategori Obat</b></span>
                    </div>
                    <select class="form-control" style="text-transform:capitalize;">
                      <option>Silahkan klik untuk memilih kategori obat</option>
                      <option>data 1</option>
                      <option>data 2</option>
                    </select>
                  </div>
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;width: 100px;"><b>Keterangan</b></span>
                    </div>
                    <input type="text" class="form-control" style="text-transform:capitalize;" /required>
                  </div>
                  <br>

                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;width: 100px;"><b>Harga Beli</b></span>
                    </div>
                    <input type="number" class="form-control" style="text-transform:capitalize;max-width: 400px;" /required min="0" step="1" placeholder="Input Harga Beli" />
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;width: 110px;"><b>Harga Jual</b></span>
                    </div>
                    <input type="number" class="form-control" style="text-transform:capitalize;max-width: 400px;" /required min="0" step="1" placeholder="Input Harga Jual" />
                    <div class="input-group-prepend">
