           ...
           <li class="nav-item">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"><a class="nav-link" href="<?php echo base_url('index.php/Admin/penjualan_pembelian'); ?>" style="color: #87CEEB;">Penjualan & Pembelian  <a class="nav-link" href="<?php echo base_url('index.php/Admin/penjualan'); ?>" style="color: black;">Penjualan <a class="nav-link" href="<?php echo base_url('index.php/Admin/pembelian'); ?>" style="color: black;">Pembelian</a></li>
                </ul>
              </div>
            </li>
            <!-- <li class="nav-item">
          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> Laporan Penjualan dan Pembelian Obat
              </h3>
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Download Data Penjualan dan Pembelian</h4>
                    <form action="<?php echo  base_url('index.php/Excel/createExcel3') ?>" method="post">
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Data Penjualan dan Pembelian</h4>
                      ...
                      <table class="table">
                        <thead>
                          <tr> 
                            ...
                            <th>Kategori Obat</th>
                            <th>Status</th>
                            <th>Jumlah Terbeli / Terjual</th>
                            <th>Sisa Stok</th>
                            <th>Harga</th>
                            <th>Total Penjualan / Pembelian</th>
                            <th>Tanggal Penjualan / Pembelian</th>
                            <th>Keterangan</th>
                           ...
                           <tbody>
                          <?php $no=0; ?>
                            <?php foreach($penjualanpembelian as $row): ?>
                          <?php $no++; ?>
                          <tr>
                            <td><?php echo $no; ?></td>
