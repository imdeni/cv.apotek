        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Download Data pembelian</h4>
                    <form action="<?php echo  base_url('index.php/Excel/createExcel2') ?>" method="post">
