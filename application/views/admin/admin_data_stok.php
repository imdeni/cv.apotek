                      ...
                      <table class="table" id="myTables">
                        <thead>
                          ...
                          <tr>
                            ...
                            <td><?php echo $row->stok; ?>/<span style="font-size: 9px"><?php echo $row2->stoknya; ?></span>
                              <?php if ($row->stok==0  ) {
                                $bar=0;
                              }else{
                                $bar=($row->stok/$row2->stoknya)*100;
                              } ?>
                              <div class="progress" style="height:10px;"><div class="progress-bar bg-gradient-info" role="progressbar" <?php echo "style='width: ".$bar."%'"; ?>></div>
                            </div>
                            </td>
