            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> 
                    <a class="nav-link" href="<?php echo base_url('index.php/Admin/v_tambah_nama_obat'); ?>" style="color: #87CEEB;">Nama Obat</a> 
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body"style="padding-left: 20px;">
                      <form method="post" action="<?php echo base_url('index.php/Tambah/t_nama_obat');?>">
                  <div class="input-group">
                    
                  </div><br>
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text" style="color:black;"><b>Nama Obat</b></span>
                    </div>
                    <input type="text" name="nama_obat" placeholder="Silahkan Isi Nama Obat" class="form-control" style="text-transform:capitalize;" /required>
                    <div class="input-group-prepend">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                  <div class="card-body">
                    ...
                    <input class="form-control" type="text" id="myInput" placeholder="Cari Nama Obat">
                    <div class="table-responsive">
                      ...
                      <?php $no++; ?>
                            ...
                            <td><?php echo $row->kode_nama; ?></td>
                            <td><?php echo $row->nama_obat; ?></td>
                            <td><center><a class="btn btn-info" style="background: white;border: 2px solid #87CEEB;color: black;" onclick="return checkDelete()" href="<?php echo base_url('index.php/Hapus/?nama_obat='.$row->nama_obat); ?>" >hapus</a></center></td>
                          </tr>
                      <?php endforeach; ?>
                        </tbody>
                      </table>
